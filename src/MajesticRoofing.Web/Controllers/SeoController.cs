...
public class SeoController : Controller
{
    ...
    [
        ("/", "1.0", "weekly"),
        ("/roof-insurance-claim-charlotte-nc", "0.9", "weekly"),
        ("/roofing-charlotte-nc", "0.8", "monthly"),
        ("/roofing-rock-hill-sc", "0.8", "monthly"),
        ("/roofing-systems-charlotte-nc", "0.8", "monthly"),
        ("/hail-damage-roof-inspection-charlotte-nc", "0.7", "monthly"),
        ("/wind-missing-shingles-repair-charlotte-nc", "0.7", "monthly"),
        ("/active-roof-leak-repair-charlotte-nc", "0.7", "monthly"),
        ("/chimney-flashing-leak-repair-charlotte-nc", "0.7", "monthly"),
        ("/open-roof-hole-decking-repair-charlotte-nc", "0.7", "monthly"),
        ("/tree-roof-damage-charlotte-nc", "0.7", "monthly")
    ];
